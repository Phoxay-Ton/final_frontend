        ...
        <div className="p-6 font-saysettha ">
          ...
          <div className="grid mt-4" >
            <div className="bg-gray-100 p-6 rounded-md shadow-md ">
              <input type="text" name="title" className="w-full p-2 mb-3 border text-black  rounded-full" placeholder="ຊື່ພະນັກງານ" />
              <input type="text" name="title" className="w-full p-2 mb-3 border text-black  rounded-full" placeholder="ທີ່ຢູ່" />
              <input type="text" name="title" className="w-full p-2 mb-3 border text-black  rounded-full" placeholder="ເບີໂທ" />
              <input type="text" name="title" className="w-full p-2 mb-3 border text-black  rounded-full" placeholder="ອີເມວ" />
              <input type="text" name="title" className="w-full p-2 mb-3 border text-black  rounded-full" placeholder="ຊື່ຜູ້ໃຊ້" />
