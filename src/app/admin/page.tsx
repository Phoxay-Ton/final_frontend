    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="w-64 bg-blue-900 text-white p-4 flex flex-col">
        ...
        <nav className="mt-6 space-y-4">
          <a href="#" className="flex items-center px-4 py-2 rounded bg-blue-800">
          ...
          <div>
            <a href="/Leave" className="flex items-center px-4 py-2">
          ...
          <a href="#" className="flex items-center px-4 py-2 bg-red-600 text-white rounded">
      ...
      <div className="flex-1 flex flex-col">
        ...
        {/* Filters */}
        <div className="">
        <div className="bg-blue-300 p-4 rounded shadow text-center font-bold"> <div className="mr-2">ຈັດການພະນັກງານ</div> </div>
          <div className="flex space-x-4 mt-2">
            <select className=" block text-gray-700 p-2 border rounded w-1/2">
              <option>ປີ</option>
        ...
        <div className="p-4 grid grid-cols-4 gap-4">
          <div className="bg-blue-300 p-4 rounded shadow text-center font-bold">ຈໍານວນຄະດີທີ່ມີຄວາມຜິດ</div>
          <div className="bg-green-300 p-4 rounded shadow text-center font-bold">ຈໍານວນຄະດີທີ່ດີສຸດ</div>
          <div className="bg-purple-300 p-4 rounded shadow text-center font-bold">ຈໍານວນຄະດີທີ່ລົ້ມເຫລວ</div>
