...
export default function Dashboard() {
    ...
    <div className="mt-6 bg-white p-6 rounded-lg shadow-lg ">
      ...
      <h3 className="text-xl font-bold text-black  font-saysettha">ມອບວຽກ</h3>
        <button className="bg-blue-600 text-white px-4 py-2 rounded-lg flex items-center space-x-2 font-saysettha">
          <FaPlus /> <span>ເພີ່ມວຽກໃຫ້ພະນັກງານ</span>
        </button>
      </div>
        ...
        <table className="w-full border-collapse border rounded-lg shadow-md">
          ...
          <tbody>
            <tr className="border-t text-black">
              <td className="p-3">phoxay@gmail.com</td>
              <td className="p-3">19/03/2025</td>
              <td className="p-3">21/03/2022</td>
  ...
  <a href=""><footer className="bg-gray-200 p-4 text-center text-black font-saysettha mt-20">ກັບໄປໜ້າ admin</footer></a>
